      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-32 text-center">
        ...
        >
          <motion.h1
            ...
            className="text-6xl md:text-8xl lg:text-9xl font-bold text-black mb-6 tracking-tight"
          >
            Ancore Digital
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-black/70 mb-8 max-w-3xl mx-auto"
          >
          ...
          >
            ...
            <motion.button
              ...
              className="px-8 py-4 bg-transparent border-2 border-black text-black rounded-full font-medium hover:bg-black hover:text-white transition-colors"
            >
              Our Services
            </motion.button>
          </motion.div>
      ...
      >
        ...
        >
          <motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ repeat: Infinity, duration: 2 }}
            className="w-1 h-3 bg-black/30 rounded-full mt-2"
          />
        </motion.div>
      </motion.div>
    </section>
